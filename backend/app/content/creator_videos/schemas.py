...
class CreatorVideoBase(BaseModel):
    creator_id: int
    write_id: int
...
class CreatorVideoCreate(CreatorVideoBase):
    pass

class CreatorVideoUpdate(BaseModel):
...
class CreatorVideoResponse(CreatorVideoBase):
...
class CreatorVideoList(BaseModel):
    items: list[CreatorVideoResponse]
    total: int
    skip: int
    limit: int
